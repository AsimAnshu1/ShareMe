...
const Navbar = ({searchTerm, setSearchTerm, user}) => {
  ...
  return (
    <div className='flex gap-2 md:gap-5 pb-7 w-full mt-5'>
   <div className='flex justify-start items-center w-full px-2 rounded-md border-none bg-white outline-none focus-within:shadow-sm'>
